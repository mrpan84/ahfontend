<template>
    <ion-breadcrumbs>
      ...
      <ion-breadcrumb href="#live auction">
  ...
  <script lang="ts">
    ...
    import { camera, film, flash, home, basket, hammerOutline} from 'ionicons/icons';
  
    export default defineComponent({
      components: { IonBreadcrumb, IonBreadcrumbs, IonIcon, IonLabel },
      setup() {
        return { camera, film, flash, home, basket, hammerOutline};
      },
    });
  </script>